...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "petapp" because\n';
  ...
  $wnd.__gwt_activeModules['petapp'] = {
    'moduleName' : 'petapp',
    'bindings' : function() {
      return {};
    }
 ...
 * "/petapp.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['petapp'].superdevmode = true;

  var expectedSuffix = '/petapp.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + petapp + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:petapp';
  var devModeSessionKey = '__gwtDevModeSession:petapp';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/petapp/petapp.nocache.js';
  ...
  $wnd.__gwt_activeModules['petapp'].canRedirect = true;
  $wnd.__gwt_activeModules['petapp'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/petapp?user.agent=' + ua + '&_callback=' + callback;
